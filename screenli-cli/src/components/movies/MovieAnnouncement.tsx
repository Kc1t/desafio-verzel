...
const MovieAnnouncement = () => {
  return (
    <div className="w-[95%] lg:w-[85%] tv:max-w-7xl sm:px-6 lg:px-8 h-[45rem] flex flex-col items-center justify-center bg-sub-dark border-2 border-white/20 rounded-2xl my-8 relative">
      <Image
        src={AnnoncementBg}
...
export default MovieAnnouncement;
